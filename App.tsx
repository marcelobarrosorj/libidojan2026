...
export default function App() {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', maxWidth: '480px', margin: '0 auto', backgroundColor: '#050505' }}>
      <header style={{ padding: '24px 20px', backgroundColor: 'rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
        <h1 style={{ fontSize: '28px', color: '#fff' }}>LIBIDO</h1>
      </header>
      <main style={{ flex: 1, padding: '80px 20px 160px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#1a0033', color: '#fff', overflowY: 'auto' }}>
        <h1 style={{ fontSize: '38px', marginBottom: '60px', fontWeight: '900', textAlign: 'center' }}>
          Assinatura Premium
        </h1>
